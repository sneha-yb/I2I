...
function ReinitializeConnection()
    ...
    RSTD.Sleep(2000)
    ar1.frequencyBandSelection("77G")
    -- (Any other configuration calls needed)
end
...
-- Modified by Qiming to change IP address
-- if (ar1.ConfigureRFDCCard_EEPROM("192.168.33.30", "192.168.33.180", "12:34:56:78:90:12", 4096, 4098) == 0) then
--     WriteToLog("ConfigureRFDCCard_EEPROM Success\n", "green")
-- else
--     WriteToLog("ConfigureRFDCCard_EEPROM failure\n", "red")
-- end
-- RSTD.Sleep(1000)
-- End modification
...
-- manually begin next sense period
...
while true do
    ...
    os.execute("mkdir \"" .. "D:\\mmWave\\raw_data"   .."\\".. tstring.."\"")
    adc_data_path = "D:\\mmWave\\raw_data".."\\"..tstring.."\\adc_data.bin"
    -- WriteToLog(adc_data_path, "red")
